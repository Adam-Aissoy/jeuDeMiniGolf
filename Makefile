...
CORE = core/Ball.cpp core/Game.cpp core/Math.cpp core/Sand.cpp core/Wall.cpp

SRCS_TXT = $(CORE) txt/main_txt.cpp txt/txt_game.cpp txt/winTxt.cpp
FINAL_TARGET_TXT = mgolf_txt
#DEFINE_TXT = -DJEU_TXT

SRCS_SDL = $(CORE) sdl2/MasterGolf.cpp sdl2/main_sdl.cpp
FINAL_TARGET_SDL = mgolf_sdl
#DEFINE_SDL = -DJEU_SDL
